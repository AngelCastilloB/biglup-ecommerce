...
export class VariantsComponent
{
    ...
    {
        this._router.navigate(['/products/edit-color-variant', id]);
    }
    ...
    {
        this._router.navigate(['/products/edit-size-variant', id]);
    }
    ...
    {
        this._router.navigate(['/products/edit-material-variant', id]);
    }
}
