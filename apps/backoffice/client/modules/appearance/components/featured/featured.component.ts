/**
 * @file featured.component.ts
 *
 * @summary The featured admin panel.
 *
...
import template from './featured.component.html';
...
/**
 * @summary This component displays the available featured.
 */
@Component({
    selector: 'featured',
    template
})
export class FeaturedComponent implements AfterViewInit, OnDestroy
{
