/**
 * @file sliders.component.ts
 *
 * @summary The sliders admin panel.
 *
...
import template from './sliders.component.html';
...
/**
 * @summary This component displays the available sliders.
 */
@Component({
    selector: 'sliders',
    template
